...
public class GrammarTest {
    ...
    private static final String CLASS_DECLARATION = "ClassDeclaration";
    ...
    public void testClass() {
        noErrors("class Foo extends Bar {}", CLASS_DECLARATION);
    }

    @Test
    public void testVarDecls() {
        noErrors("class Foo {int a; int[] b; int c; boolean d; Bar e;}", CLASS_DECLARATION);
    }
